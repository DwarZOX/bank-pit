...
const Input = ({type,className,placeholder,label,labelValue,value,classNameLabel,eyeIcon,eventOnChange,disable}) => {
  ...
  return (<>
      ...
      <div className='flex justify-between items-center  border-b-2 border-black'>
        <input type={showPW? 'text' : type} id={label} className={`${className} focus:outline-0`} placeholder={placeholder} value={value} onChange={(e)=>eventOnChange(e.target.value)} disabled={disable}/>
