...
const Form = ({value,onChange,text,type,placeholder,newPass,setNewPass,setConfirmPass,confirmNewPass,isShow,setIsShow}) => {
  return (
    <>
          ...
          <Input className={'bg-transparent placeholder:text-slate-200 md:w-[280px]'} classNameWrap={'mt-10 md:mt-0'} classNameLabel={'md:mt-6'} type={'password'} eyeIcon={true} value={confirmNewPass} eventOnChange={setConfirmPass} setIsShow={setIsShow} placeholder={'Konfirmasi kata sandi'}/>
