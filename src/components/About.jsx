...
import woman1 from '../assets/img/womanrb.png'
import woman2 from '../assets/img/womanrb1.png'
import woman3 from '../assets/img/womanrb2.png'
import man1 from '../assets/img/manrb.png'
import man2 from '../assets/img/manrb1.png'
import feature1 from '../assets/img/inforek.png'
import feature2 from '../assets/img/inforek2.png'
...
const About = () => {
  ...
  <>
    <div className="about-us mt-10 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="-mt-20 md:-mt-80 flex flex-col items-center gap-y-10 my-5">
