...
const PassForgot = () => {
  ...
  const {setRole,setDisplayName,loggedIn,setLoggedIn,isShow,setIsShow} = useStateContext()
  ...
  const elemWillDisplay = () => {
    if(page === 1) {
      ...
      return <Form newPass={newPass} isShow={isShow} setNewPass={setNewPass} text={'Silahkan buat kata sandi baru Anda.'}  type={'password'} confirmNewPass={confirmNewPass} setConfirmPass={setConfirmNewPass}/>
    } else if (page === 4){
      ...
      if (email !== '') {
        ...
        instance.request(config)
          ...
          .catch((error) => {
            ...
            Toast.fire({
              icon: 'warning',
              title: 'Email tidak terdaftar pada Bank PIT!'
            })
          });
      } else {
        const Toast = Swal.mixin({
  ...
  return (
    ...
    <div className="my-20 h-full flex justify-center">
